...
<div class="brand-promotion">
    ...
    <div class="mainBox">
        ...
        <div class="jinxin-data">
            <h3>平台用户数</h3>
            <div class="data"><span id="hzxx_ljrs">${sumUserCount}</span>位</div>
            <div class="line"></div>
            <h3>累计成交额</h3>
...
<div id="productArea">
	...
	<div class="index-exper">
     <div class="inner">
        <c:forEach items="${xLoanList}" var="xl">
            <div class="index-exper-top">
                <span class="title"><font style="font-size:28px;">${xl.productName}</font></span>
                <p class="text">${xl.bidMinLimit}元起投<em>丨
                </em>投资最高限额${xl.bidMaxLimit}元<em>丨</em>当日计息</p>
            </div>
	...
	<div class="mainBox pro-body disperse-pro clearfix">
        ...
        <c:forEach items="${yLoanList}" var="yl" varStatus="sta">
            <!-- 1:已满标时追加pro-full-->
            <div class="pro-box <c:if test='${yl.leftProductMoney eq 0}'>pro-full</c:if>">
                <div class="pro-top">
                    <h3>${yl.productName}</h3>
                    <p>动力金融网特选小额理财产品</p>
                </div>
                <div class="pro-main">
                    <div class="pro-rate">
                        <div class="rate">${yl.rate}<span>%</span></div>
                        <h3>历史年化收益率</h3>
                    </div>
    ...
    <div class="mainBox pro-body disperse-pro clearfix">
        <div class="new-pro-icon"><img src="images/new-pro-icon.png"/></div>
        <c:forEach items="${sLoanList}" var="sLoanInfo" varStatus="index">
    ...
    <div class="pro-more"><i class="left-i"></i><a href="loan/loan.do?ptype=2">查看更多散标类产品</a><i class="right-i"></i></div>
    <!-- 散标end -->
</div>
<!--投资产品end-->
