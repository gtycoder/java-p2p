...
<%--		     <div class="login-yzm">
		     <div id="showCaptcha" class="yzm-box" style="display:block;">
			 	...
			 	<img src="jcaptcha/captcha" alt="图片看不清？点击重新得到验证码" id="imgCode" onclick="this.src='jcaptcha/captcha?d='+new Date().getTime()" style="cursor:pointer;border:0; display:inline;vertical-align:middle;" />
		     </div>
        ...
        <div class="login-right">
          ...
          <div class="top-txt">
		          动力金融网，便捷的投资平台
			<br/><br/>
			加入动力金融网<br/>坐享<span class="historyAvgRate">--</span>%历史年化收益
          </div>
           
          <div class="currently">
          	平台用户数：<span id="userCount">--</span>位，累计成交额： <span id="sumBidMoney">--</span>元
          </div>
          
          <div class="bn-reg" id="quickRegBtn">
            <button onclick="location.href='register.jsp'">马上注册</button>
          </div>
           ...
           <ul class="clearfix">
            <li><i></i>
              <h3>优选投资计划</h3>
              <p>
              	历史年化收益<span><span class="historyAvgRate">--</span>%</span><br/>
