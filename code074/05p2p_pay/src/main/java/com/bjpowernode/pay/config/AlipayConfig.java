...
public class AlipayConfig {
    ...
    public static String notify_url = "http://localhost:8080/myWeb/loan/alipaynotifyBack";

    // 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    //这个就是支付宝返回回来的请求的连接
    public static String return_url = "http://localhost:8080/myWeb/loan/alipayreturnBack";
